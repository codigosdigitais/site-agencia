...
class CI_Email {
	...
	var	$smtp_host		= "smtp.inoveinternet.com.br";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "smtp@inoveinternet.com.br";		// SMTP Username
	var	$smtp_pass		= "12inove34";		// SMTP Password
