<section class="section section-breadcrumb">
    <div class="parallax-container breadcrumb-wrapper" data-parallax-img="<?php echo base_url('site/assets'); ?>/images/conteudo/agencia.jpg">
        <div class="parallax-content section-lg context-dark">
            <div class="shell context-dark">
                <h2>Códigos Digitais - Agência Digital</h2>
    ...
    <ul class="breadcrumb-custom">
        <li><a href="./">Home</a></li>
        <li>Uma trajetória de sucesso</li>
    </ul>
</section>
...
<section class="section section-lg bg-white">
   <div class="shell">
      <div class="range range-md-middle range-30">
         <div class="cell-md-6"><img src="<?php echo base_url('site'); ?>/assets/images/conteudo/agencia-803x550.jpg" alt="" width="803" height="550"/>
         </div>
         <div class="cell-md-4">
            <h2 class="heading-with-aside-divider">A Agência<span class="divider"></span></h2>
            ...
            <p class="text-justify">Somos muito mais do que uma agência Digital, com 20 anos de experiência para compartilhar, entendemos que o comprometimento com os resultados reais dos clientes é o melhor combustível.</p>
            ...
            <div class="owl-carousel" data-items="1" data-sm-items="3" data-md-items="3" data-lg-items="4" data-stage-padding="0" data-loop="true" data-autoplay="true" data-margin="30" data-mouse-drag="false" data-nav-custom="#owl-carousel-nav">
               ...
               <div class="item wow fadeInUp" data-wow-delay=".8s">
                  <div class="vip">
                     ...
                     <div class="vip-content">
                        <h5><a href="https://api.whatsapp.com/send?phone=5545999244900&text=Oi. Entrei no site da agência e preciso de um orçamento. Ref: Desenvolvimento de Sistemas" target="_blank">Desenvolvimento de Sistemas</a></h5>
